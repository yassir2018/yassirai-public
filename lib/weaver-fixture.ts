...
export function weaverFixture(lang: Locale): Template[] {
  return RAW.map((x) => ({
    ...
    description: x[lang],
    status: "DONE",
    previewUrl: `https://pub-9c404a6a434c4363be2c253e38e6c8d7.r2.dev/weaver/${x.path}/index.html`,
    saleUrl: null,
    thumbnailUrl: `https://pub-9c404a6a434c4363be2c253e38e6c8d7.r2.dev/weaver/assets/img/${x.thumb}`,
    category: x.category,
